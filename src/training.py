...
if __name__ == '__main__':
    ...
    if not args.compile_only:
        ...
        aip.init(project=envs['project_id'],
                 location=envs['region'],
                 staging_bucket=pipelines_uri)
        job = aip.PipelineJob(
            enable_caching=args.enable_caching,
            display_name=args.timestamp,
            pipeline_root=pipelines_uri,
            template_path=f'./compiled/training_{args.timestamp}.json',
            parameter_values={
